...
"""The graphical part of a xnn step"""
...
class TkXnn(seamm.TkNode):
    """
    The graphical part of a xnn step in a flowchart.
    ...
    self[widget] : dict
        ...
        contained in xnn_parameters.py
    ...
    def create_dialog(self):
        ...
        based on what is specified in the xnn_parameters
        module.
        ...
        frame = super().create_dialog(title="xnn")
