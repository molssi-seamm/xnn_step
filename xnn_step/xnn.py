...
path = importlib.resources.files("xnn_step") / "data"
...
class Xnn(seamm.Node):
    """
    The non-graphical part of a xnn step in a flowchart.
    ...
    parameters : XnnParameters
        The control parameters for xnn.
    ...
    def description_text(self, P=None):
        ...
        text = (
            ...
            "xnn step, including key parameters."
        )
    ...
    def analyze(self, indent="", **kwargs):
        ...
        printer.normal(
            __(
                "This is a placeholder for the results from the xnn step",
                indent=4 * " ",
                wrap=True,
                dedent=False,
            )
